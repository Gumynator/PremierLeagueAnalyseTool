...
case class League(players: List[Players] ){
        /**
         ...
         * @return
         */
        def changeClub(team:String,name:String):League = {
         ...
         * @return
         */
        def addPlayer(player:Players):League={
         ...
         * @return
         */
        def deletePlayer(name:String, team:Option[String]) : League = {
            team match {
